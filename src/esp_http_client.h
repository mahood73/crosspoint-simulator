...
// The firmware redeclares esp_crt_bundle_attach as `extern "C" extern` and links
// against ESP-IDF for the real implementation. In the simulator we satisfy the
// link with a no-op stub.
extern "C" {
